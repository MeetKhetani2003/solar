...
/**
 * WhatsAppCTA — Sticky WhatsApp Contact Button
 * Fixed bottom-right floating button. Appears after scrolling 300px.
 * Design uses existing brand primary color (#EA580C) — no layout change.
