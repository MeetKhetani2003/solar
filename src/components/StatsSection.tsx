...
function StatCounter({ value, suffix, label }: { value: number, suffix: string, label: string }) {
  ...
  return (
    <>
      <dd className="flex items-baseline justify-center gap-1 mb-4">
        ...
        <span className="font-heading text-4xl md:text-5xl font-medium text-primary" aria-hidden="true">{suffix}</span>
      </dd>
      <dt className="text-xs md:text-sm font-sans font-bold text-muted-foreground tracking-[0.2em] uppercase">
        {count}{suffix} {label}
      </dt>
    </>
  );
